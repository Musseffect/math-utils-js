...
export class JSGenerator extends RandomGenerator {
    randomUnit() {
        return Math.random();
    }
    randomInt() {
...
export class WELL512a extends RandomGenerator {
    state: number[];
    stateIdx = 0;
...
export function randomNormalDistr(generator: RandomGenerator = new JSGenerator()) {
